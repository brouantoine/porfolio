...
import { RiFacebookCircleFill, RiWhatsappFill, RiMailFill, RiGlobalLine, RiSendPlaneFill, RiUserFill, RiMessage2Fill } from 'react-icons/ri';
        ...
        <div className="contact-form-container">
          <motion.form className="contact-form" onSubmit={handleSubmit} initial={{ x: -30, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.4 }}>
            ...
            <div className="form-group">
              ...
              <textarea id="message" name="message" value={formData.message} onChange={handleChange} rows="5" required placeholder="Décrivez votre projet..." />
            </div>
